...
/***/ function(module, exports, __webpack_require__) {
	...
	var _login = __webpack_require__(398);

	var _repos = __webpack_require__(399);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function starRepo(usernameRepo, username, password) {
	    ...
	    _superagent2.default.put(url).auth(username, password).end(function (err, res) {
	        if (err || !res.ok) {
	            ...
	            alert('yay got ' + (0, _stringify2.default)(res.body));
	        }
	    });
	}
	...
	var Repo = (function (_React$Component) {
	    ...
	    function Repo() {
	        ...
	        return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(Repo).apply(this, arguments));
	    }
	...
	var RepoList = exports.RepoList = (function (_React$Component2) {
	    (0, _inherits3.default)(RepoList, _React$Component2);

	    function RepoList() {
	        (0, _classCallCheck3.default)(this, RepoList);
	        return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(RepoList).apply(this, arguments));
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Emitter = __webpack_require__(403);
